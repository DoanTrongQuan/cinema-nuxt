  ...
  <div v-if="isShowLoading" class="loading fixed inset-0 z-[53] bg-white">
    ...
    >
      <div class="relative w-">
        <div class="logo absolute w-[250px] h-[50px] -translate-x-[40%]" style="bottom: calc(100% + 40px)">
          <img src="/img/logo_cinema.png" class="w-full h-full" alt="" />
        </div>

        <svg
          aria-hidden="true"
          class="w-14 h-14 text-gray-200 animate-spin block mx-auto dark:text-gray-600 fill-[#ff7764]"
          viewBox="0 0 100 101"
          fill="none"
